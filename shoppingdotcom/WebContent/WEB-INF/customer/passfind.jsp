...
<c:if test="${empty tempps }">
	<script type="text/javascript">
		alert("잘못된 정보를 입력하셨습니다.");
		history.go(-1);
	</script>
</c:if>
<c:if test="${not empty tempps}">
	<div style="text-align:center;">
   <h2 style="color:orange;margin-bottom: 10px;">비밀번호 찾기</h2>
   <div class="find-box">임시 비밀번호가 생성되었습니다<p>
   <span style="font-weight:bold;">${tempps }</span></div><p>
