...
<input type="hidden" name="cid" value="${customer.cid }">
	<table><caption><h2>회원정보 수정</h2></caption>
		<tr><th>암호</th><td colspan="2"><input type="password" name="cpass" required="required"></td></tr>
		<tr><th>암호 확인</th><td colspan="2"><input type="password" name="confrimPass" required="required"></td></tr>
		<tr><th>이름</th><td colspan="2"><input type="text" name="cname" required="required" value="${customer.cname }"></td></tr>
		<tr><th rowspan="3">주소</th><td colspan="2"><input type="text" id="postcode" name="cpostcode" placeholder="우편번호" autocomplete="off" value="${customer.cpostcode }" required="required">
		<input type="button" onclick="execDaumPostcode()" value="우편번호 찾기" style="width:120pt; margin-left:50px;float:right;"></td></tr>
		<tr><td colspan="2" style="border-top:0"><input type="text" id="address" name="address" placeholder="주소" autocomplete="off" value="${customer.caddr }" required="required"></td></tr>
		<tr><td colspan="2" style="border-top:0"><input type="text" id="detailAddress" name="detailAddress" placeholder="상세주소" autocomplete="off" value="${customer.cdetailaddr }" required="required">
		<div style="display: none;"><input type="text" id="extraAddress" name="extraAddress" placeholder="참고항목" ></div></td></tr>
		...
		<tr><th>이메일</th><td colspan="2"><input type="email" name="cemail" required="required" value="${customer.cemail }" autocomplete="off"></td></tr>
		<tr><th>생년월일</th><td colspan="2"><input type="text" name="cbir" required="required" value="${customer.cbir }"
		placeholder="8글자로 입력하세요" autocomplete="off"></td></tr>
		<tr><td colspan="3" style="text-align:center;border-right:0"><input type="submit" value="수정"></td></tr>	
	</table>
</form>
