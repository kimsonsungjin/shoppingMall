...
<meta charset="UTF-8">
<title>게시글 등록</title>
<link rel="stylesheet" href="home.css"><link rel="stylesheet" href="nav.css"><link rel="stylesheet" href="join.css">
</head>
<body>
...
<table style="width:850px;"><caption><h2>게시글 등록</h2></caption>
	<tr><th>제목</th><td><input type="text" name="nsubject" required="required" autofocus="autofocus" style="float:left"></td></tr>
	<tr><th>본문</th><td><textarea rows="10" cols="100" name="ncontent" style="float:left" required="required"></textarea></td></tr>
