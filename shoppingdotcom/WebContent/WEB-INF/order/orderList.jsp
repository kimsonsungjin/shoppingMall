...
<div class="row justify-content-center">
	<div class="col-sm-8">
    <table class="table table-responsive text-center"><caption><h2 class="cart">주문조회</h2></caption>
    ...
    <tr>
      ...
      <td><a href="orderProInfo.or?ocode=${orderlist.ocode }&cid=${sessionScope.cid}" style="color:black;">${orderlist.oinfo }</a></td>
      <td>${orderlist.oaddr }</td>
      <td>${orderlist.oprice }</td>
      <td>${orderlist.omemo }</td>
      <c:if test="${orderlist.odel == 'n'}"><td>주문완료<br><button onclick="location.href='orderCancle.or?ocode=${orderlist.ocode}'">주문취소</button></td></c:if>
