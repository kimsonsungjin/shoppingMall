...
$(document).ready(function() {
	...
	$('.cloth').change(function() {
		...
		if(sel == 'T1000'){
			$('.op').remove();
			$('.cl').append('<option class="op">-- 소분류 선택 --</option>')
...
<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
	...
	<!-- 파일이 존재하는 경우 반드시 enctype을 변경해 주어야 합니다. -->
	<form action="registerPro.pro" method="post" enctype="multipart/form-data">
		<table align="center"><caption><h2>상품등록</h2></caption>
			<!-- <tr>
			...
			<tr>
				...
				<td>&nbsp; <input type="number" name="pprice" required="required" />
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>&nbsp;<input type="file" name="pimage[]" multiple="multiple" required="required"/><br/>
				</td>
			<tr>
				<td align="right">상품설명&nbsp;</td>
				<td>&nbsp;<textarea rows="10" cols="30" name="pcon" required="required"></textarea>
				</td>
			</tr>
			<tr>
