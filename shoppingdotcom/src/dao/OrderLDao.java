...
public class OrderLDao {
	...
	public int update(String ocode) {
		return session.update("orderlns.update", ocode);
	}
	public List<OrderL> allList(int startRow, int endRow) {
		HashMap<String, Integer> hm = new HashMap<String, Integer>();
		hm.put("startRow",startRow );
		hm.put("endRow",endRow );
		return session.selectList("orderlns.allList",hm);
	}
	public int total() {
		return (int) session.selectOne("orderlns.total");
	}
}
